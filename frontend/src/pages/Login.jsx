      ...
      <div className="flex flex-1 flex-col justify-center px-4 py-12 sm:px-6 lg:w-1/2 lg:px-20 xl:px-24 bg-white overflow-y-auto">
        <div className="mx-auto w-full max-w-sm lg:w-96">
          ...
          <div>
            ...
            <h2 className="mt-6 text-2xl font-bold text-gray-900 tracking-tight">Welcome back</h2>
          ...
          <div className="mt-8">
            <form onSubmit={handleSubmit} className="space-y-5" id="loginForm">
              ...
              <div className="flex items-center justify-between">
                ...
                <button 
                  type="button" 
                  onClick={() => alert("Fitur Lupa Password saat ini belum tersedia (Backend API belum dibuat).")} 
